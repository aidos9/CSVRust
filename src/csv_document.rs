        ...
        while i < characters.len() {
            ...
            if characters[i] == '\n' && !in_quotes {
                if !header_row_set {
                    ...
                    let res = CSVRow::parse_line_new(&line);
...
mod tests {
    ...
    fn test_to_string_single_line() {
        let doc: CSVDocument = CSVDocument {
            header: CSVRow {
                cells: vec![
                    String::from("name"),
                    String::from("dob"),
    ...
    #[test]
    fn test_add_row() {
        let mut doc: CSVDocument = CSVDocument {
            header: CSVRow {
                cells: vec![
                    String::from("name"),
                    String::from("dob"),
